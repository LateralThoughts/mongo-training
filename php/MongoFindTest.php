...
class MongoFindTest extends PHPUnit_Framework_TestCase {
    ...
    public function testThatMovieWithGenreCrimeAre69(){
        ...
        $nbCrimeMoviesInDatabase = $this->movies->count(["genres" => "Crime"]);
    ...
    public function testProjectionOnTitle(){
        ...
        $movie = $this->movies->findOne([], ["projection" => ["title" => true, "_id" => false]]);
    ...
    public function testRatingBetween8And9(){
        ...
        $nbMoviesInRange89 = $this->movies->count(["rating" => ['$gt'=> 8, '$lt' => 9]]);
    ...
    public function testAllMovieComedyAndRomance(){
        ...
        $nbComedyAndRomanceMovies = $this->movies->count(["genres" => ['$all'=> ['Comedy', 'Romance']]]);
    ...
    public function testAllMovieNotComedyAndRomance(){
        ...
        // TODO
        $nbMoviesNeitherRomanceNeitherComedy = $this->movies->count(["genres" => ['$nin'=> ['Comedy', 'Romance']]]);
    ...
    public function testAllMovieScienceFictionOrWithMorganFreeman(){
        ...
        // TODO
        $nbSciFiMoviesOrWithMorganFreeman = $this->movies->count(['$or' => [["genres" => 'Sci-Fi'], ['actors' => 'Morgan Freeman']]]);;
    ...
    public function testAllMoviesWithFieldAlsoKnownAs(){
        ...
        // TODO
        $nbMoviesWithAnAlias = $this->movies->count(["also_known_as" => ['$exists'=> true]]);
    ...
    public function testMoviesLocationMatchingNewYork(){
        ...
        // TODO
        $nbMoviesFilmedInNewYork = $this->movies->count(["filming_locations" => ['$regex'=> new MongoDB\BSON\Regex ("new york", 'i')]]);
